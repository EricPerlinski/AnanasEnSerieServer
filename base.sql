...
CREATE TABLE `like` (id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
...
CREATE TABLE yesno (id INT NOT NULL, nopath VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
...
ALTER TABLE `like` ADD CONSTRAINT FK_AC6340B3BF396750 FOREIGN KEY (id) REFERENCES qrcode (id) ON DELETE CASCADE;
