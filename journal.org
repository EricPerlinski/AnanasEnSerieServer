...
* <2014-12-18 jeu.>
** Ce qui doit etre fait
*** DONE faire des stats avancés (par rapport aux heure, ...)
*** DONE faire les sondages evolués
**** DONE oui/non
**** DONE sondage
*** DONE securiser avec des .htacces, ...
** Problèmes
** Ce qu'il reste a faire
** Indicateurs projet
*** nombre de taches effectuees 31
*** nombre de post-it utilises 46
*** nombre de commits 353
...
** Ce qu'il reste a faire
** Indicateurs projet
*** nombre de taches effectuees 35
*** nombre de post-it utilises 55
*** nombre de commits 400
*** nombre d'ananas consommes 4
