CREATE TABLE checkboxanswer (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
CREATE TABLE checkboxanswer_answers (checkboxanswer_id INT NOT NULL, answer_id INT NOT NULL, INDEX IDX_539F00BD651CD234 (checkboxanswer_id), UNIQUE INDEX UNIQ_539F00BDAA334807 (answer_id), PRIMARY KEY(checkboxanswer_id, answer_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
...
CREATE TABLE checkboxquestion (id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
CREATE TABLE checkboxquestion_answers (question_id INT NOT NULL, answer_id INT NOT NULL, INDEX IDX_16C5DF741E27F6BF (question_id), UNIQUE INDEX UNIQ_16C5DF74AA334807 (answer_id), PRIMARY KEY(question_id, answer_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
...
CREATE TABLE openanswer (id INT AUTO_INCREMENT NOT NULL, answer LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
CREATE TABLE openquestion (id INT NOT NULL, question LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
CREATE TABLE openquestion_answers (question_id INT NOT NULL, answer_id INT NOT NULL, INDEX IDX_A7C7E4E61E27F6BF (question_id), UNIQUE INDEX UNIQ_A7C7E4E6AA334807 (answer_id), PRIMARY KEY(question_id, answer_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
CREATE TABLE radiobuttonanswer (id INT AUTO_INCREMENT NOT NULL, answer_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8DA839A9AA334807 (answer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
...
CREATE TABLE radiobuttonquestion_answers (question_id INT NOT NULL, answer_id INT NOT NULL, INDEX IDX_69D94D491E27F6BF (question_id), UNIQUE INDEX UNIQ_69D94D49AA334807 (answer_id), PRIMARY KEY(question_id, answer_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
...
CREATE TABLE survey_answers (survey_id INT NOT NULL, question_id INT NOT NULL, INDEX IDX_14FCE5BDB3FE509D (survey_id), INDEX IDX_14FCE5BD1E27F6BF (question_id), PRIMARY KEY(survey_id, question_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
CREATE TABLE yesno (id INT NOT NULL, counterno INT NOT NULL, question VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
...
ALTER TABLE checkboxanswer_answers ADD CONSTRAINT FK_539F00BD651CD234 FOREIGN KEY (checkboxanswer_id) REFERENCES checkboxanswer (id);
ALTER TABLE checkboxanswer_answers ADD CONSTRAINT FK_539F00BDAA334807 FOREIGN KEY (answer_id) REFERENCES item (id);
ALTER TABLE checkboxquestion ADD CONSTRAINT FK_23F8E378BF396750 FOREIGN KEY (id) REFERENCES question (id) ON DELETE CASCADE;
ALTER TABLE checkboxquestion_answers ADD CONSTRAINT FK_16C5DF741E27F6BF FOREIGN KEY (question_id) REFERENCES checkboxquestion (id) ON DELETE CASCADE;
ALTER TABLE checkboxquestion_answers ADD CONSTRAINT FK_16C5DF74AA334807 FOREIGN KEY (answer_id) REFERENCES checkboxanswer (id);
...
ALTER TABLE openquestion_answers ADD CONSTRAINT FK_A7C7E4E61E27F6BF FOREIGN KEY (question_id) REFERENCES openquestion (id) ON DELETE CASCADE;
ALTER TABLE openquestion_answers ADD CONSTRAINT FK_A7C7E4E6AA334807 FOREIGN KEY (answer_id) REFERENCES openanswer (id);
ALTER TABLE radiobuttonanswer ADD CONSTRAINT FK_8DA839A9AA334807 FOREIGN KEY (answer_id) REFERENCES item (id);
...
ALTER TABLE radiobuttonquestion_answers ADD CONSTRAINT FK_69D94D491E27F6BF FOREIGN KEY (question_id) REFERENCES radiobuttonquestion (id) ON DELETE CASCADE;
ALTER TABLE radiobuttonquestion_answers ADD CONSTRAINT FK_69D94D49AA334807 FOREIGN KEY (answer_id) REFERENCES radiobuttonanswer (id);
...
ALTER TABLE survey_answers ADD CONSTRAINT FK_14FCE5BDB3FE509D FOREIGN KEY (survey_id) REFERENCES survey (id) ON DELETE CASCADE;
ALTER TABLE survey_answers ADD CONSTRAINT FK_14FCE5BD1E27F6BF FOREIGN KEY (question_id) REFERENCES question (id);
